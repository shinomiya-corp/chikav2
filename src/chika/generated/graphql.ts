...
export type AnimeQuery = (
  ...
  & { Media?: Maybe<(
    { __typename?: 'Media' }
    & Pick<Media, 'description' | 'season' | 'seasonYear' | 'status' | 'averageScore' | 'episodes' | 'source' | 'genres' | 'isAdult'>
    & { title?: Maybe<(
      { __typename?: 'MediaTitle' }
...
export type CharacterQuery = (
  ...
  & { Character?: Maybe<(
    { __typename?: 'Character' }
    & Pick<Character, 'description' | 'age' | 'gender' | 'siteUrl'>
    & { name?: Maybe<(
      { __typename?: 'CharacterName' }
      & Pick<CharacterName, 'full' | 'native'>
    )>, image?: Maybe<(
      { __typename?: 'CharacterImage' }
...
export type MangaQuery = (
  ...
  & { Media?: Maybe<(
    { __typename?: 'Media' }
    & Pick<Media, 'description' | 'status' | 'averageScore' | 'genres' | 'chapters' | 'volumes' | 'source' | 'isAdult'>
    & { title?: Maybe<(
      { __typename?: 'MediaTitle' }
      & Pick<MediaTitle, 'userPreferred'>
    )>, startDate?: Maybe<(
...
export const AnimeDocument = gql`
    query anime($search: String, $type: MediaType) {
...
export const CharacterDocument = gql`
    query character($charName: String) {
...
export const MangaDocument = gql`
    query manga($search: String, $type: MediaType) {
  Media(search: $search, type: $type) {
    title {
      userPreferred
    }
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    anime(variables?: AnimeQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<AnimeQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<AnimeQuery>(AnimeDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'anime');
    },
    ...
    manga(variables?: MangaQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<MangaQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<MangaQuery>(MangaDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'manga');
    }
  };
}
